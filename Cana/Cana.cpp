...
Cana_Renderer Cana::createRenderer(const int surface_width, const int surface_height, const float fov)
{
    /* Create drawing surface */
    renderer.createDrawingSurface(surface_width, surface_height, fov);
    return renderer;
}
